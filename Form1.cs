...
namespace AracListesi /*bu uygulama 21015122005 okul numaralı ilkay eren tarafından yapılmiştır bitirdiği tarih: 09.01-11.05.2023*/
{
    public partial class Form1 : Form
    {
        ...
        {
            new Arac()
            { /*uygulama üzerinde bu araçlar varken kayıtlı aaa dosyasını çalıştırdığım 
                için başlattığımda gözükmüyor ilk çalıştırdığımda gözüküyordu*/
                Plaka = "06 ern 06",
                Marka = "togg",
                Model = "2023",
                Yakıt = "dizel",
                ...
                Vites = "otomatik",
                KasaTipi = "haxpack",
                Aciklama = "doktordan temiz kullanıldı 1 aylık",
            },
            new Arac()
            {
                Plaka = "12 abc 34",
                ...
                Vites = "düz",
                KasaTipi = "sedan",
                Aciklama = "otobanda size göz kırpan araba",
            }
        };
    ...
    public class Arac
    {
        ...
        //Plaka, Marka, Model, Yakıt, Renk, Vites, KasaTipi, Aciklama
